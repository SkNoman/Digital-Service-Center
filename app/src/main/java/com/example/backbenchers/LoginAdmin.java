...
public class LoginAdmin extends AppCompatActivity {
    ...
    String token,userenterdusername;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SessionManager sessionManager = new SessionManager(LoginAdmin.this,SessionManager.SESSION_REMEMBERME);
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            FirebaseDatabase.getInstance()
                                    .getReference("users")
                                    .child(username.getEditText().toString())
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    if (passwordFromDB.equals(userEnteredPassword))
                    {
                        ...
                        //create session here
                        SessionManager sessionManager = new SessionManager(LoginAdmin.this,SessionManager.SESSION_USERSESSION);
                        sessionManager.createLoginSession(nameFromDB,usernameFromDB,emailFromDB,phoneFromDB,cityFromDB,passwordFromDB);

                        // SharedPreferences.Editor editor = sharedPreferences.edit();
                        //editor.putString(KEY_USERNAME,username.getEditText().getText().toString());
                        // editor.putString(KEY_PASSWORD,password.getEditText().getText().toString());
                        // editor.apply();
